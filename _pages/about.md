...
- Applied data augmentation to address class imbalance and improve robustness.  
- Trained EfficientNetB7 with Progressive Self-Knowledge Distillation (PS-KD).  
- Used Test-Time Augmentation (TTA), achieving **99.967% accuracy**.
...
- Fine-tuned LLMs for cognitive and behavioral analysis tasks.  
...
- Evaluated YOLOv8, PP-Detection, Mediapipe, TinyPose on custom datasets.  
- Improved detection accuracy by **3%** and keypoint accuracy by **10%**, reducing redundant detection errors.
...
- Coursework: Operating Systems, Data Structures & Algorithms, etc.
